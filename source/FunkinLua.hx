...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "triggerEvent", function(name:String, arg1:Dynamic, arg2:Dynamic, time:Dynamic) {
			var value1:String = arg1;
			var value2:String = arg2;
			var ti:Float = time;
			if(Math.isNaN(ti) || time == null)ti = Conductor.songPosition;
			PlayState.instance.triggerEventNote(name, value1, value2, ti);
